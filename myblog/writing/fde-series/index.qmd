...
The quickest test of whether a requirement is genuinely descriptive is to **ask what would be different in the business at the end, and how we would know.** If the answer is a list of things to build, or a platform to prove, the requirement is prescriptive whatever language surrounds it — the deliverable is the requirement, and the outcome is decoration.
