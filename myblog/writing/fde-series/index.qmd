...
They are numbered, but they don't queue up neatly. The handover question has to be answered before the building starts, and the prioritisation question gets asked every week. What they share is the constraint above, and each section is a position I've arrived at by getting it wrong at least once.
...
On a demand-forecasting engagement, the leading measures might be: a baseline for the current process, measured by week four; an evaluation gate the customer's own experts have calibrated, and that can stop a release; a model in production by week twelve, serving every SKU in the pilot stores; three of the customer's engineers shipping changes through that gate without us; monitoring and a runbook live. Each of those should have a reason it moves inventory. If you can't give one, you're measuring activity, or you've missed a driver.

The targets have to be realistic. We're timeboxed, and we should only put a number down if we're confident it's reachable inside the window. We won't always hit them, and being slightly off is an easy conversation. Hitting a third of them isn't, and that's ours to answer for. Naming them is how we put skin in the game, especially with customers who haven't worked with us before. They can be contractual — milestones, acceptance, payment — and, like everything else, they're revisited as the engagement teaches us more.

Most of that list is capability rather than software. A baseline the customer owns, a gate their experts calibrated, a runbook they operate, three engineers shipping without us — those are things the organisation can do at the end that it couldn't at the start. That's what co-engineering buys and scoped implementation doesn't. The leading measures are the transfer, and the outcome is what the customer goes on to do with it once we've gone. A customer who only wanted the model has cheaper ways to get one.
